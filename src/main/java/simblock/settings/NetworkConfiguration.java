...
public class NetworkConfiguration {
  ...
  /**
   * The cumulative distribution of number of outbound links for Bitcoin 2015 CSV file path.
   * It contains the distribution of number of outbound links. Cf. Andrew Miller et al.,
   * "Discovering bitcoin's public topology and influential nodes", 2015.,
   * Starting from  Figure 4: Degree distributions from AddressProbe runs on 10/20–11/7. mean,
   * points were evaluated from the graph.
   * Using Matlab, the curve has been fitted and evaluated.
   *
   * <p>Smoothing spline:
   * f(x) = piecewise polynomial computed from p
   * where x is normalized by mean 28.28 and std 108.7
   * Smoothing parameter:
   * p = 0.9999999
   * Goodness of fit:
   * SSE: 0.0004523
   ...
   * RMSE: 0.004438
   */
  private static final String DEGREE_DISTRIBUTION_BITCOIN_2015 = "node_degree_cdf_btc_2015.csv";
  /**
   * The cumulative distribution of number of outbound links. Cf. Andrew Miller et al.,
   * "Discovering bitcoin's public topology and influential nodes", 2015.
   */
  public static final String DEGREE_DISTRIBUTION_PATH_STRING = DEGREE_DISTRIBUTION_BITCOIN_2015;
  /**
