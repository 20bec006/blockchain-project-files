 ...
 */
public abstract class AbstractConsensusAlgo extends TimerCarrier {
  private final AbstractNode selfNode;
   ...
   */
  public AbstractConsensusAlgo(AbstractNode selfNode, Timer timer) {
    super(timer);
   ...
   */
  public AbstractNode getSelfNode() {
  ...
  public abstract AbstractMintingTask genesisBlockTask();
}
